      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-border pb-8">
        <div>
          ...
          <p className="text-navy-500 mt-3 text-lg max-w-2xl">
            Schedule, manage agendas, and access board papers for all organizational governance sessions.
          </p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button className="px-5 py-2.5 bg-emerald-600 text-white rounded-xl text-sm font-bold transition-all hover:bg-emerald-700 hover:shadow-xl hover:shadow-emerald-600/20 flex items-center gap-2">
