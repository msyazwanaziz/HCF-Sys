...
function renderTable() {
    ...
    displayData.forEach(item => {
        ...
        tr.innerHTML = `
            ...
            <td><span class="status-badge ${statusClass}" style="padding: 0.2rem 0.5rem; border-radius: 10px; font-size: 0.8rem;">${statusText}</span></td>
            <td style="text-align: center;">
                <button onclick="window.open('receipt.html?id=${encodeURIComponent(item.id)}', '_blank')" style="background: none; border: none; cursor: pointer; color: var(--accent-primary); padding: 0.2rem;" title="Print Receipt">
